  ...
  <div class="row m-0 p-0 w-100 posts-section">
    <div class="row justify-content-center m-0 w-100">
      <div class="col-md-6 p-0">
        <div class="text-center app-page-subtitle create-title">EDIT A TRADE</div>
        ...
        <div class="post-top-content">
          ...
          <div class="content trade-address">
              @if (!empty($trade->address))
                  @php
                      echo $trade->address;
                  @endphp
              @else
          ...
          <div class="col-4 col-sm-4 col-md-4 contentItem">
              <div class="contentItem-wrp">
                  <div class="optional-section">
                      <img class="option-icon featured-image-upload plus-post-image1 {{ $trade->small_featured_image1_url ? 'd-none' : '' }}" attr-data="thumbnail1" src="{{ asset('images/svg/ImageGreen.svg') }}">
                      <span class="option-icon trash-featured-image post-image1 {{ $trade->small_featured_image1_url ? '' : 'd-none' }}" attr-data="thumbnail1"><i class="fa fa-trash" aria-hidden="true"></i></span>
                  </div>
                  <div class="image-container post-image1 {{ $trade->small_featured_image1_url ? '' : 'd-none' }}"></div>
                  <img src="{{ asset('uploads/posts/'.$trade->small_featured_image1_url.'?'.time()) }}" class="post-image1 {{ $trade->small_featured_image1_url ? '' : 'd-none' }} blur-img" />
              </div>
          </div>
          <div class="col-4 col-sm-4 col-md-4 contentItem">
              <div class="contentItem-wrp">
                  <div class="optional-section">
                      <img class="option-icon featured-image-upload plus-post-image2 {{ $trade->small_featured_image2_url ? 'd-none' : '' }}" attr-data="thumbnail2" src="{{ asset('images/svg/ImageGreen.svg') }}">
                      <span class="option-icon trash-featured-image post-image2 {{ $trade->small_featured_image2_url ? '' : 'd-none' }}" attr-data="thumbnail2"><i class="fa fa-trash" aria-hidden="true"></i></span>
                  </div>
                  <div class="image-container post-image2 {{ $trade->small_featured_image2_url ? '' : 'd-none' }}"></div>
                  <img src="{{ asset('uploads/posts/'.$trade->small_featured_image2_url.'?'.time()) }}" class="post-image2 {{ $trade->small_featured_image2_url ? '' : 'd-none' }}" />
              </div>
          </div>
          <div class="col-4 col-sm-4 col-md-4 contentItem">
              <div class="contentItem-wrp">
                  <div class="optional-section">
                      <img class="option-icon featured-image-upload plus-post-image3 {{ $trade->small_featured_image3_url ? 'd-none' : '' }}" attr-data="thumbnail3" src="{{ asset('images/svg/ImageGreen.svg') }}">
                      <span class="option-icon trash-featured-image post-image3 {{ $trade->small_featured_image3_url ? '' : 'd-none' }}" attr-data="thumbnail3"><i class="fa fa-trash" aria-hidden="true"></i></span>
                  </div>
                  <div class="image-container post-image3 {{ $trade->small_featured_image3_url ? '' : 'd-none' }}"></div>
                  <img src="{{ asset('uploads/posts/'.$trade->small_featured_image3_url.'?'.time()) }}" class="post-image3 {{ $trade->small_featured_image3_url ? '' : 'd-none' }}" />
              </div>
          </div>
        </div>
