...
<head>
  ...
  <title>{{ generateAppTitle() }} @yield('title')</title>
...
<body>
  ...
  <script type="text/javascript">
    ...
    $('.prev').on('click', function () {
      srcIndex--;
      if (srcIndex < 0) {
        localStorage.setItem('srcIndex', 66);
        srcIndex = 66;
      }
      else {
    ...
    function updateVideoSource() {
      ...
      if (!mediaQuery.matches) {
        video = document.querySelector('.wave-video-section');
        ...
        video = document.querySelector('.wave-video-section-mobile');
        video.style.display = 'none';
