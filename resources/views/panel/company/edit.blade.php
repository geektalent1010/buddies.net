        ...
        <div class="row m-0 mx-auto p-0 setting-section">
            ...
            <div class="row justify-content-center m-0 p-0 w-100">
                <div class="col-md-6 p-0">
                            ...
                            @if (isset($user->profile->main_avatar_url))
                                <div class="contentItem-wrp face">
                                    <div class="optional-section">
                                        <span class="option-icon trash-avatar" attr-data="main_avatar"><i
                                                class="fa fa-trash" aria-hidden="true"></i></span>
                                    </div>
                                    <div class="image-container"></div>
                                    <img class="avatar" alt="main avatar"
                        ...
                        @if (isset($user->profile->banner_img_url))
                            <div class="contentItem-wrp main-avatar">
                                <div class="optional-section banner-section">
                                    <span class="option-icon trash-avatar" attr-data="banner_img"><i class="fa fa-trash"
                                                                                                     aria-hidden="true"></i></span>
                                </div>
                                <div class="image-container"></div>
                                <img class="" alt="main avatar"
                                     src="{{ asset('uploads/'.$user->username.'/'.$user->profile->banner_img_url.'?'.time()) }}">
                            </div>
                        @else
                            <div class="contentItem-wrp main-avatar">
                                <div class="optional-section banner-section">
                                    <img class="option-icon avatar-upload" attr-data="banner_img"
                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                </div>
                            ...
                            <div class="contact-info contentItem">
                                <div class="profile-card profile-card-bg h-100 d-flex flex-column flat-scroll">
                                    ...
                                    <div class="d-flex align-items-center profile-card-context">
                                        <span class="contact-info-icon mr-2"><i class="fa fa-phone"
                                                                                aria-hidden="true"></i></span>
                                        <span
                                            class="profile-card-context mb-0 phone-edit">{{ $user->profile->phone ?? 'Phone Number' }}</span>
                                    </div>
                                    <div class="d-flex align-items-center profile-card-context">
                                        <span class="contact-info-icon mr-2"><i class="fa fa-envelope"
                                                                                aria-hidden="true"></i></span>
                                        <span
                                            class="profile-card-context mb-0 email-edit">{{ $user->email ?? 'main@yourwebsite.com' }}</span>
                                    </div>
                                    <div class="d-flex align-items-center profile-card-context">
                                        <span class="contact-info-icon mr-2"><i class="fa fa-mouse-pointer"
                                                                                aria-hidden="true"></i></span>
                                        <span
                                            class="profile-card-context mb-0 site-edit">{{ $user->profile->site_url ?? 'www.yourwebsite.com' }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row justify-content-center m-0 p-0 w-100 card-border-wrp">
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->logo_url))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="company_logo"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                                    src="{{ asset('uploads/'.$user->username.'/'.$user->profile->logo_url.'?'.time()) }}">
                                            </div>
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="company_logo"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url2))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail2"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail2"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url3))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail3"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail3"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url4))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail4"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail4"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url5))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail5"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail5"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url6))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail6"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail6"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url7))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail7"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail7"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 contentItem thumbnail-card-border">
                                        @if (isset($user->profile->other_avatar_url8))
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <span class="option-icon trash-avatar" attr-data="thumbnail8"><i
                                                            class="fa fa-trash" aria-hidden="true"></i></span>
                                                </div>
                                                <div class="image-container"></div>
                                                <img
                                        ...
                                        @else
                                            <div class="contentItem-wrp">
                                                <div class="optional-section">
                                                    <img class="option-icon avatar-upload" attr-data="thumbnail8"
                                                         src="{{ asset('images/svg/ImageGreen.svg') }}">
                                                </div>
                                                <div class="thumbnail-card">
                                                </div>
                    ...
                    <form class="form-section" data-form="update-user-detail" autocomplete="off" method="POST"
                          action="{{ route('setting.update.detail') }}">
                        @csrf
                                ...
                                <div class="detail-info-section">
                                    <div class="form-group">
                                        <input type="text" name="vat_number" class="form-control" id="vatNumber"
                                               placeholder="VAT Number" value="{{ $user->profile->vat_number ?? '' }}">
                                        <label id="vat-number-error" class="has-error" for="vat_number"
                                               style="display: none"></label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3 mx-0">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <div class="form-group">
                                        <input type="text" name="phone" class="form-control" id="mobileNumber"
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <div class="form-group">
                                        <input type="text" name="site_url" class="form-control" id="siteUrl"
                                               placeholder="Website" value="{{ $user->profile->site_url ?? '' }}">
                                        <label id="site-url-error" class="has-error" for="site_url"
                                               style="display: none"></label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3 mx-0">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <input type="text" name="city" class="form-control" id="real-city"
                                           placeholder="City"
                                           value="{{ isset($user->profile->city) ? $user->profile->city : '' }}" hidden>
                                    <div class="form-group search-city">
                                        <input type="text" class="form-control" id="city" placeholder="City"
                                               value="{{ empty($city) ? isset($user->profile->city) ? $user->profile->city : 'City' : $city }}"
                                               onchange="changeCity()">
                                ...
                                <div class="detail-info-section">
                                    <div class="form-group">
                                        <input type="text" name="postal_code" class="form-control" id="postalCode"
                                               placeholder="Zip Code" value="{{ $user->profile->postal_code ?? '' }}">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <input type="text" name="country" class="form-control" id="real-country"
                                           placeholder="Country"
                                           value="{{ isset($user->profile->country) ? $user->profile->country : '' }}"
                                           hidden>
                                    <div class="form-group mb-0">
                                        <input type="text" class="form-control disabled" id="country"
                                               placeholder="Country"
                                               value="{{ empty($country) ? isset($user->profile->country) ? $user->profile->country : 'Country' : $country }}"
                                               disabled>
                        ...
                        <div class="row mt-3 mx-0">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <div class="form-group">
                                        <input type="text" name="username" class="form-control disabled" id="username"
                                               placeholder="User Name" value="{{ $user->username }}" disabled>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <input type="password" name="changePassword" class="form-control"
                                           id="change-password" placeholder="Password" value="0" hidden>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="detail-info-section">
                                    <input type="password" name="confirmPassword" class="form-control"
                                           id="confirm-password" placeholder="Password" value="0" hidden>
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control"
                                               id="password-confirm" placeholder="Password" value="">
                                        <label id="password-confirm-error" class="has-error" for="password"
                                               style="display: none"></label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        const updateUserDetail = {
            ...
            validateSiteUrlInput: function () {
                ...
                if ((/^(https?:\/\/)?(www\.)?[a-z0-9\-]+(\.[a-z0-9\-]+)+([/?].*)?$/i.test(value))) {
