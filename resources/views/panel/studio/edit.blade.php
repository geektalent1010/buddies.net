            ...
            <div class="m-0 p-0 tab left-menu menuItem">
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div id="studio1-tab" class="thumbnail-card portfolio-image tablinks active"
                             onclick="openTab(event, 'studio1')">
                            <p>1</p>
                        </div>
                    </div>
                </div>
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div id="studio2-tab" class="thumbnail-card portfolio-image tablinks"
                             onclick="openTab(event, 'studio2')">
                            <p>2</p>
                        </div>
                    </div>
                </div>
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div id="studio3-tab" class="thumbnail-card portfolio-image tablinks"
                             onclick="openTab(event, 'studio3')">
                            <p>3</p>
                        </div>
                    </div>
                </div>
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div id="studio4-tab" class="thumbnail-card portfolio-image tablinks"
                             onclick="openTab(event, 'studio4')">
                            <p>4</p>
                        </div>
                    </div>
                </div>
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div
                            class="thumbnail-card portfolio-image color-change-white {{ $user->profile->darken_mode_1 == 0 ? 'active' : '' }}"
                            onclick="imgColorToWhite()">
                ...
                <div class="contentItem">
                    <div class="contentItem-wrp">
                        <div
                            class="thumbnail-card portfolio-image color-change-black {{ $user->profile->darken_mode_1 == 1 ? 'active' : '' }}"
                            onclick="imgColorToBlack()">
                    ...
                    <div class="col-12 col-sm-12 studioItem">
                        <div class="studioItem-wrp tabcontent" id="studio1">
                            <div class="thumbnail-card portfolio-image" attr-data="studio-image-1">
                                <img
                                    class="option-icon image-upload plus-studio-image-1 {{ $user->profile->studio_image1 ? 'd-none' : '' }}"
                                    attr-data="studio-image-1" src="{{ asset('images/svg/ImageGreen.svg') }}">
                                <span
                                    class="option-icon image-remove remove-studio-image-1 {{ $user->profile->studio_image1 ? '' : 'd-none' }}"
                                    attr-data="studio-image-1"><i class="fa fa-trash" aria-hidden="true"></i></span>
                                <div
                                    class="image-container blur-image-1 {{ $user->profile->darken_mode_1 == 0 ? 'd-none' : '' }}"></div>
                                <div class="cropme" attr-data="studio-image-1"></div>
                                <input id="selectedFile" class="file-selector__input selectedFile" type='file'
                                       accept=".png, .jpg, .jpeg, .svg">
                                <img id='crop__result' class="crop__result" src=''>
                                @if ($user->profile->studio_image1)
                                    <img
                                        src="{{ asset('uploads/'.$user->username.'/'.$user->profile->studio_image1.'?'.time()) }}"
                                        class="studio-image remove-studio-image-1 {{ $user->profile->studio_image1 ? '' : 'd-none' }}"/>
                                @endif
                            </div>
                        ...
                        <div class="studioItem-wrp tabcontent" id="studio2">
                            <div class="thumbnail-card portfolio-image" attr-data="studio-image-2">
                                <img
                                    class="option-icon image-upload plus-studio-image-2 {{ $user->profile->studio_image2 ? 'd-none' : '' }}"
                                    attr-data="studio-image-2" src="{{ asset('images/svg/ImageGreen.svg') }}">
                                <span
                                    class="option-icon image-remove remove-studio-image-2 {{ $user->profile->studio_image2 ? '' : 'd-none' }}"
                                    attr-data="studio-image-2"><i class="fa fa-trash" aria-hidden="true"></i></span>
                                <div
                                    class="image-container blur-image-2 {{ $user->profile->darken_mode_2 == 0 ? 'd-none' : '' }}"></div>
                                <div class="cropme" attr-data="studio-image-2"></div>
                                <input id="selectedFile" class="file-selector__input selectedFile" type='file'
                                       accept=".png, .jpg, .jpeg, .svg">
                                <img id='crop__result' class="crop__result" src=''>
                                @if ($user->profile->studio_image2)
                                    <img
                                        src="{{ asset('uploads/'.$user->username.'/'.$user->profile->studio_image2.'?'.time()) }}"
                                        class="studio-image remove-studio-image-2 {{ $user->profile->studio_image2 ? '' : 'd-none' }}"/>
                                @endif
                            </div>
                        ...
                        <div class="studioItem-wrp tabcontent small-image" id="studio3">
                            <div class="thumbnail-card portfolio-image" attr-data="studio-image-3">
                                <img
                                    class="option-icon image-upload plus-studio-image-3 {{ $user->profile->studio_image3 ? 'd-none' : '' }}"
                                    attr-data="studio-image-3" src="{{ asset('images/svg/ImageGreen.svg') }}">
                                <span
                                    class="option-icon image-remove remove-studio-image-3 {{ $user->profile->studio_image3 ? '' : 'd-none' }}"
                                    attr-data="studio-image-3"><i class="fa fa-trash" aria-hidden="true"></i></span>
                                <div
                                    class="image-container blur-image-3 {{ $user->profile->darken_mode_3 == 0 ? 'd-none' : '' }}"></div>
                                <div class="cropme" attr-data="studio-image-3"></div>
                                <input id="selectedFile" class="file-selector__input selectedFile" type='file'
                                       accept=".png, .jpg, .jpeg, .svg">
                                <img id='crop__result' class="crop__result" src=''>
                                @if ($user->profile->studio_image3)
                                    <img
                                        src="{{ asset('uploads/'.$user->username.'/'.$user->profile->studio_image3.'?'.time()) }}"
                                        class="studio-image remove-studio-image-3 {{ $user->profile->studio_image3 ? '' : 'd-none' }}"/>
                                @endif
                            </div>
                        ...
                        <div class="studioItem-wrp tabcontent small-image" id="studio4">
                            <div class="thumbnail-card portfolio-image" attr-data="studio-image-4">
                                <img
                                    class="option-icon image-upload plus-studio-image-4 {{ $user->profile->studio_image4 ? 'd-none' : '' }}"
                                    attr-data="studio-image-4" src="{{ asset('images/svg/ImageGreen.svg') }}">
                                <span
                                    class="option-icon image-remove remove-studio-image-4 {{ $user->profile->studio_image4 ? '' : 'd-none' }}"
                                    attr-data="studio-image-4"><i class="fa fa-trash" aria-hidden="true"></i></span>
                                <div
                                    class="image-container blur-image-4 {{ $user->profile->darken_mode_4 == 0 ? 'd-none' : '' }}"></div>
                                <div class="cropme" attr-data="studio-image-4"></div>
                                <input id="selectedFile" class="file-selector__input selectedFile" type='file'
                                       accept=".png, .jpg, .jpeg, .svg">
                                <img id='crop__result' class="crop__result" src=''>
                                @if ($user->profile->studio_image4)
                                    <img
                                        src="{{ asset('uploads/'.$user->username.'/'.$user->profile->studio_image4.'?'.time()) }}"
                                        class="studio-image remove-studio-image-4 {{ $user->profile->studio_image4 ? '' : 'd-none' }}"/>
                                @endif
                            </div>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered crop__modal">
            <div class="modal-content crop__modal-content modal-content1">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn crop__action" data-dismiss="modal"><i data-feather="x"></i>
                    </button>
