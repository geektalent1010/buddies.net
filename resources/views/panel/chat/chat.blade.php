@extends('layouts.app', ['ACTIVE_TITLE' => 'CHAT', 'ACTIVE_CHAT_ROUTES' => true, 'ACTIVE_PAGE' => 'chatting', 'CHATTING_ROUTE' => url('') . '/messages/' . auth()->user()->id . '_' . $channelInfo->otherUser->id])
