        ...
        <div class="login-page">
            ...
            <div class="form-group row justify-content-center pt-3">
                <div class="col-12 text-center">
                    ...
                    <div class="login-title text-center mb-0 mt-2">
                        <span>CLICK FOR A PRIVATE ACCOUNT</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center pt-3">
                <div class="col-12 text-center">
                    ...
                    <div class="login-title text-center mb-0 mt-2">
                        <span>CLICK FOR A COMPANY ACCOUNT</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form class="form-section" data-form="register" autocomplete="off" method="POST" action="{{ route('register') }}">
                ...
                <div class="row mx-0 mt-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="login-page">
                            <div class="form-group d-flex pt-2.5 pl-4">
                ...
                <div class="row mx-0 mt-4 company-details-section">
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="login-title info-title">
                ...
                <div class="row mx-0 mt-4">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="login-page">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="state" placeholder="Area" onchange="changeArea()">
...
@section('PAGE_LEVEL_SCRIPTS')
    <script type="text/javascript">
        ...
        $('.select-type').on('click', function() {
            ...
            $('.registration-phone-label').html('COMPANY PHONE NUMBER');
            $('.registration-email-lable').html('COMPANY EMAIL ADDRESS');
            if (user_type == 0) {
                $('.registration-title').html('PRIVATE REGISTRATION');
                $('.registration-phone-label').html('PHONE NUMBER');
                $('.registration-email-lable').html('EMAIL ADDRESS');
